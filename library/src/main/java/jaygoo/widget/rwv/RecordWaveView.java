...
public class RecordWaveView extends RenderView {
    private int first_color[]={0xFF28D81B,0xFF0A9B0C,0xFFF19309,0xFFFD1504};
    private int second_color []={0xFF0AF5D9,0xFF0A44F1,0xFFFFEB3B,0xFFFD1504};
...
//                ContextCompat.getColor(getContext(),R.color.secondPathColor));
        firstPathColor=Color.BLUE;
        secondPathColor=Color.GREEN;
    ...
    public void setFirst_color(int i){
        switch (i){
            case 0:
               // firstPathColor=first_color[0];
                firstPathColor=Color.BLUE;
                break;
            case 1:
              //  firstPathColor=first_color[1];
                firstPathColor=Color.BLUE;
                break;
            case 2:
              //  firstPathColor=first_color[3];
                firstPathColor=Color.YELLOW;
                break;
            case 3:
            //    firstPathColor=first_color[2];
                firstPathColor=Color.RED;
                break;
        }
    }
    public void setSecond_color(int i) {
        switch (i) {
            case 0:
              //  secondPathColor=second_color[0];
                secondPathColor=Color.GREEN;
                break;
            case 1:
               // secondPathColor=second_color[1];
                secondPathColor=Color.GREEN;
                break;
            case 2://生气
                //secondPathColor=second_color[2];
                secondPathColor=Color.YELLOW;
                break;
            case 3://尖叫
             //   secondPathColor=second_color[3];
                secondPathColor=Color.RED;
                break;
        }
    }
